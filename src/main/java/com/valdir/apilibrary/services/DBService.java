...
public class DBService {
	...
	public void instantiateTestDataBase() {
		...
		Book b1 = new Book(null, "Clean Code");
		Book b2 = new Book(null, "Code Complete");
		Book b3 = new Book(null, "Desingn Patterns");
		Book b4 = new Book(null, "How to make friends and influence people");
		Book b5 = new Book(null, "The Power of Now");
